...
?>
    <script src="<?= get_bloginfo("template_url"); ?>/js/rendro-easy-pie-chart/dist/easypiechart.js"></script>
    <script>
    ...
    <div class="custom-page-container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 contacts-text">
                ...
                <h3>Телефон / GSM</h3>
                <div class=""><a href="tel: + 359 887 376 123">+ 359 887 376 123</a></div>
            </div>
            <div class="col-md-4 contacts-text">
