<div id="welcome-screen">
    <div id="logo2"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    ...
    <div id="welcome-text">РЕГИОНАЛЕН ИНФОРМАЦИОНЕН ПОРТАЛ<span style="display:block">В УСЛУГА НА <span style="color:orange;">БИЗНЕСА И ПОТРЕБИТЕЛЯ</span></span>
        <div id="btn-enter" class="btn btn-success">ВХОД <svg id="timer" width="18" height="18" viewbox="0 0 250 250">
...
return;
//echo get_field( 'img', $taxonomy.'_'.$term->term_id)
