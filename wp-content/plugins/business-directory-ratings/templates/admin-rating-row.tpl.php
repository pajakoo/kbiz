<?php if ( !isset( $i ) ) $i = 0; ?>
    <tr class="<?php echo $i % 2 == 0 ? 'even' : 'odd'; ?>" data-id="<?php echo $review->id; ?>">
        <td class="authoring-info">
            <span class="wpbdp-ratings-stars" data-readonly="readonly" data-value="<?php echo $review->rating; ?>"></span><br />
            <b>
        ...
        <td class="comment">
            ...
            <div class="comment-edit" style="display: none;">
                ...
                <input type="button" value="<?php _e('Cancel', 'wpbdp-ratings'); ?>" class="cancel-button button" />
                <input type="button" value="<?php _e('Save', 'wpbdp-ratings'); ?>" class="save-button button-primary button" />
            </div>            
        </td>
    </tr>
