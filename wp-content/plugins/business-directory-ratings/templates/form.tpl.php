<input type="button" class="wpbdp-show-on-mobile show-review-form-button" value="<?php _e( 'Post your review', 'wpbdp-ratings' ); ?>" />
<script type="text/javascript">
// <![CDATA[
jQuery(function($) {
    $( '.show-review-form-button' ).click(function() {
        $( '.review-form' ).toggle();
    });
});
// ]]>
...
<div class="review-form wpbdp-hide-on-mobile">

<div class="review-form-header wpbdp-hide-on-mobile">
...
<div class="form">
    ...
    <?php endif; ?>
        ...
        <form action="#rate-listing-form" method="POST">
            ...
            <p class="allowed-tags"> <?php printf( __( 'You may use these HTML tags: %s.', 'wpbdp-ratings'), '<span>' . allowed_tags() . '</span>' ); ?></p>
            <?php endif; ?>
            <?php endif; ?>
